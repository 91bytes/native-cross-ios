...
class SessionTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        configuration.applicationNameForUserAgent = "Native Cross iOS Test/1.0"
    ...
    func test_init_initializesWebViewWithConfiguration() {
        XCTAssertEqual(session.webView.configuration.applicationNameForUserAgent, "Native Cross iOS Test/1.0")
    }
