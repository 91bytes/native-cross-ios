...
(function (global, factory) {
  ...
  class Location {
    ...
    isPrefixedBy(location) {
      ...
      return (
        this.isEqualTo(location) ||
        stringStartsWith(this.absoluteURL, prefixURL)
      );
    }
    isEqualTo(location) {
  ...
  class FetchResponse {
    ...
    get isHTML() {
      return (
        this.contentType &&
        this.contentType.match(/^text\/html|^application\/xhtml\+xml/)
      );
    }
    get statusCode() {
    ...
    scrollFrameIntoView(frame) {
      if (this.element.autoscroll || frame.autoscroll) {
        ...
        const block = readScrollLogicalPosition(
          this.element.getAttribute("data-autoscroll-block"),
          "end"
        );
        if (element) {
  ...
  const StreamActions = {
    append() {
      var _a;
      (_a = this.targetElement) === null || _a === void 0
        ? void 0
        : _a.append(this.templateContent);
    },
    prepend() {
      var _a;
      (_a = this.targetElement) === null || _a === void 0
        ? void 0
        : _a.prepend(this.templateContent);
    },
    remove() {
      var _a;
      (_a = this.targetElement) === null || _a === void 0
  ...
  class StreamElement extends HTMLElement {
    ...
    get targetElement() {
      var _a;
      if (this.target) {
        return (_a = this.ownerDocument) === null || _a === void 0
          ? void 0
  ...
  (() => {
    ...
    while ((element = element.parentElement)) {
      if (element == document.body) {
        ...
        For more information, see: https://turbo.NativeCrossd.dev/handbook/building#working-with-script-elements
  ...
  class Snapshot {
    ...
    clone() {
      const { bodyElement } = Snapshot.fromHTMLString(
        this.bodyElement.outerHTML
      );
    ...
    getPermanentElements() {
      return [
        ...this.bodyElement.querySelectorAll("[id][data-turbo-permanent]"),
      ];
    }
    ...
    stop() {
      ...
      if (this.started) {
        history.scrollRestoration =
          (_a = this.previousScrollRestoration) !== null && _a !== void 0
            ? _a
            : "auto";
      ...
      if (formSubmission == this.formSubmission) {
        ...
        if (responseHTML) {
          if (formSubmission.method != FetchMethod.get) {
            console.log(
              "Clearing snapshot cache after successful form submission"
            );
    ...
    constructor(delegate) {
      ...
      this.inspectFetchResponse = (event) => {
        ...
        if (
          ...
          StreamMessage.contentType + "; charset=utf-8"
        ) {
          event.preventDefault();
  ...
  function fetchResponseFromEvent(event) {
    ...
    if (
      ((_a = event.data) === null || _a === void 0
        ? void 0
        : _a.fetchResponse) instanceof FetchResponse
    ) {
  ...
  class ErrorRenderer extends Renderer {
    constructor(delegate, html) {
      ...
      this.newHead =
        this.htmlElement.querySelector("head") ||
        document.createElement("head");
      this.newBody =
        this.htmlElement.querySelector("body") ||
  ...
  class Session {
    ...
    renderStreamMessage(message) {
      document.documentElement.appendChild(
        StreamMessage.wrap(message).fragment
      );
    }
    clearCache() {
      this.view.clearSnapshotCache();
    ...
    notifyApplicationAfterClickingLinkToLocation(link, location) {
      return dispatch("turbo:click", {
        target: link,
        detail: { url: location.absoluteURL },
        cancelable: true,
      });
    }
    ...
    notifyApplicationAfterPageLoad(timing = {}) {
      return dispatch("turbo:load", {
        detail: { url: this.location.absoluteURL, timing },
      });
    }
